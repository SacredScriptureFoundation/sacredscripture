...
/**
 * This interface defines a a {@link Book} in absolute terms. This is necessary
 ...
 */
public interface BookType extends Entity<Long>, LocalizableContainer<BookTypeLocalization>, Named, Coded<String> {
    // empty
}
